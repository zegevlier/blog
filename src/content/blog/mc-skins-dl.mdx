...
If you have a use for it, you can download the database [at this URL](https://mcskins.zegs.me/skins14m.sqlite). I have not yet explored the data much, but if and when I do I'll post a link to any results on this blog post!
